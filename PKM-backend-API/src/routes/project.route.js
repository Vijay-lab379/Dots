...
router
    ...
    .put(validateProjectPermision([UserRolesEnum.ADMIN]), creatProjectValidator(), validate, updateProject)
    .delete(validateProjectPermision([UserRolesEnum.ADMIN]), deleteProject)

router
    .route("/:projectId/members").get(getProjectMembers)
    .post(
